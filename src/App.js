...
return (
  <div>
    <Header/>
  <div className="flex flex-col lg:flex-row m-5 justify-between">
      <div className="mr-5">
        <VideoPlayer src={selectedVideo.src} thumb={selectedVideo.thumb} autoplay />
      </div>
      <div className="">
        <Playlist playlist={playlist} onSelectVideo={handleSelectVideo} />
      </div>
